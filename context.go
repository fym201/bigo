...
// Context represents the runtime context of current request of Bigo instance.
...
func (ctx *Context) QueryInt(name string) int {
	return utl.Str(ctx.Query(name)).MustInt()
}

// QueryInt64 returns query result in int64 type.
func (ctx *Context) QueryInt64(name string) int64 {
	return utl.Str(ctx.Query(name)).MustInt64()
}

// QueryFloat64 returns query result in float64 type.
func (ctx *Context) QueryFloat64(name string) float64 {
	return utl.Str(ctx.Query(name)).MustFloat64()
}
...
func (ctx *Context) ParamsFloat64(name string) float64 {
	return utl.Str(ctx.Params(name)).MustFloat64()
}
...
func (ctx *Context) GetCookieInt(name string) int {
	return utl.Str(ctx.GetCookie(name)).MustInt()
}

// GetCookieInt64 returns cookie result in int64 type.
func (ctx *Context) GetCookieInt64(name string) int64 {
	return utl.Str(ctx.GetCookie(name)).MustInt64()
}

// GetCookieFloat64 returns cookie result in float64 type.
func (ctx *Context) GetCookieFloat64(name string) float64 {
	return utl.Str(ctx.GetCookie(name)).MustFloat64()
}
...
func (ctx *Context) SetSuperSecureCookie(secret, name, value string, others ...interface{}) {
	...
	text, err := utl.AESEncrypt([]byte(secret), []byte(value))
	if err != nil {
...
func (ctx *Context) GetSuperSecureCookie(secret, key string) (string, bool) {
	...
	m := md5.Sum([]byte(secret))
	secret = hex.EncodeToString(m[:])
	text, err := utl.AESDecrypt([]byte(secret), data)
